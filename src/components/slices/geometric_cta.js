  ...
  return (
     ...
     >
      <div className="grid grid-cols-5 grid-rows-2 mt-24 text-black overflow-x-hidden">
        <div
          className={`w-56 lg:w-72 h-56 lg:h-72 bg-breathe-blue-1 z-30 col-start-4 row-start-1 -ml-16 md:-ml-8 lg:-ml-20 ${data
            .primary.translucent_squares && "opacity-50"}`}
        ></div>
        <div
          className={`w-56 lg:w-72 h-56 lg:h-72 bg-white z-10 col-start-2 row-start-2 -ml-20 md:ml-0 lg:ml-16 -mt-48 ${data
            .primary.translucent_squares && "opacity-50"}`}
        ></div>
        <div
        ...
        <div className="text-center col-start-1 col-end-6 lg:col-start-2 lg:col-end-5 row-start-1 z-40 flex justify-end flex-col">
          <h2 className="font-serifAlt whitespace-no-wrap text-4xl lg:text-6xl">
            {data.primary.title}
          </h2>
        </div>
